...
# ---------------------------------------------------------------------------
# Resolve paths relative to this file's new location (backend/)
# ---------------------------------------------------------------------------
_AGENT_DIR  = Path(__file__).parent / "pageIndex_agent"          # backend/pageIndex_agent/
_BACKEND    = _AGENT_DIR / "backend_python"                       # backend/pageIndex_agent/backend_python/

# Make backend_python/ importable (database, routes.*)
if str(_BACKEND) not in sys.path:
    sys.path.insert(0, str(_BACKEND))

# Make pageIndex_agent/ importable (Agents.*, pageindex.*)
